...
def xt_var(φ: float, σ: float, npts: int) -> numpy.ndarray[float]:
    """
...
def yt_var(φ: float, σ: float, β: float, npts: int) -> numpy.ndarray[float]:
    """
   ...
   npts: int
    ...
    return xt_var(φ, σ, npts) * β**2

def cov(φ: float, σ: float, β: float, npts: int) -> numpy.ndarray[float]:
    """
